...
var ssgContentPlugin = async () => {
  const contentCollection = process.env.NODE_ENV !== "production" ? {} : await import_glob.default.sync(
    ...
    const contentLoader = (0, import_fs.readFileSync)(b).toString();
    const transpiledContentLoader = import_typescript.default.transpileModule(
      contentLoader,
      {
        compilerOptions: {
          target: 1,
...
var src_default = ssgContentPlugin;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {});
//# sourceMappingURL=ssgContentPlugin.js.map
'undefined'!=typeof module&&(module.exports=ssgContentPlugin),'undefined'!=typeof window&&(ssgContentPlugin=ssgContentPlugin);